    ...
    <>
      ...
      <form action={login} method="post" class="flex flex-col gap-4">
        ...
        <label class="input input-bordered flex items-center gap-2">
          ...
          <input type="password" class="grow" value="" name="password" placeholder="Mot de passe"/>
        </label>

        <input type="submit" class="ms-auto mt-4 btn btn-sm btn-primary" value="Se connecter" />
      </form>
    </>
  );
};
